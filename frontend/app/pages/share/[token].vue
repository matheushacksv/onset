    ...
    <template v-else-if="view === 'ready' && material">
      ...
      <section v-show="tab === 'crm'">
        ...
        <div class="max-w-6xl mx-auto px-6 pt-5 flex items-center gap-2 overflow-x-auto sm:flex-wrap [&::-webkit-scrollbar]:hidden [scrollbar-width:none]">
          <span class="text-xs font-semibold text-[#9a9088] uppercase tracking-widest mr-1 shrink-0">Funil</span>
          <button
          ...
          <span class="w-px h-4 bg-[#e2d8c5] mx-1 shrink-0" />
          <span class="text-xs font-semibold text-[#9a9088] uppercase tracking-widest mr-1 shrink-0">Canal</span>
          <button
        ...
        <div v-if="currentFunnel" class="sm:hidden mt-4">
          ...
          <p class="text-center text-xs text-[#9a9088] pb-5 pt-1">
